...
raw <- read.csv("~/Desktop/Landfills/AK_raw.csv", stringsAsFactors = FALSE)
size <- nrow(raw)


# Get Place IDs (and cities)
...
write.csv(details, "~/Desktop/Landfills/AK_details.csv")


# Get counties and zip codes
...
details <- read.csv("~/Desktop/Landfills/AK_details.csv", stringsAsFactors = FALSE)
